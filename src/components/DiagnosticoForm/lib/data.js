...
export const QUESTIONS = [
  ...
  },
  {
    ...
    type: 'radio',
    conditional: (answers) => !!(answers.q7 && answers.q7.site), // só mostra se marcou site
    options: [
...
// =================================================================
// PESQUISAS DE RISCO — 8 pesquisas universais
// Cada uma aparece no Result SOMENTE se a função `mostrar(answers)` retornar true.
// Lógica: regra direta (sem pontos, sem threshold).
// =================================================================
...
const temWhatsBusiness = (answers) => answers.q7 && answers.q7.whatsapp_business
const temLP = (answers) => answers.q7 && answers.q7.landing_page
...
export const PESQUISAS = [
  ...
  // 3 - Atendimento lento
  {
    ...
    fonte: 'HubSpot State of Sales, 2025',
    mostrar: (answers) => answers.q2 === '1a3h' || answers.q2 === 'mais3h',
  },

  // 4 - Atendimento sem automação
  {
    id: 4,
  ...
  // 7 - Confiança vem da presença digital
  {
    id: 7,
...
// Helper: filtra as pesquisas visíveis baseado nas respostas
...
export function calculateScore(answers) {
  ...
  // Q7: canais digitais (max 56 — 8 canais × 7)
  ...
  // Q2: bônus por tempo de atuação (max 10)
...
// =================================================================
// POTENCIAL DE GANHO (previsão baseada no score)
// Não é cálculo individual — é REFERÊNCIA DE MERCADO.
// Baseado em benchmarks do que empresas com score X costumam
// recuperar ao implementar estrutura + automação.
// 3 cenários: conservador, provável (destaque), otimista.
// =================================================================
export function calcularPotencial(answers) {
  // Primeiro calcula o score pra saber a faixa
  const score = calculateScore(answers)

  // Define faixas de potencial baseado na gravidade do score
  let faixas
  if (score < 20) {
    // Estrutura crítica — maior upside
    faixas = [
    ...
    // Excelente — pouco upside, mas sempre há o que otimizar
    faixas = [
...
// =================================================================
// ESCOLHA DE PESQUISAS (lógica nova, baseada em regras)
// =================================================================
// Retorna as pesquisas visíveis para este perfil de usuário.
// O Result exibe TODAS as que retornarem true.
...
export function generatePlano(answers, sinaisEscolhidos) {
  ...
  // Anúncios (só se tiver estrutura)
